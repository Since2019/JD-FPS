...
class WeaponAppearance:
    def __init__(self,session):
        ...
        from bolt_rifle import BoltRifle
        self.bolt=BoltRifle(session,gun);self.player_parts+=self.bolt.parts;self.parts.extend((session.weapon,a) for a in self.bolt.parts)
    def select(self,entry):
        ...
        for a in self.bolt.parts:a.set_actor_hidden_in_game(not entry or self.variant!='BOLT')
